...
(
    ...
    () =>
    {
        ...
        it
        (
            'should format all ESLint results at once',
            async () =>
            {
                const formatResults = createFormatter(4);
                const files = getFiles();
        ...
        it
        (
            'should work with a formatter object',
            async () =>
            {
        ...
        it
        (
            'should not attempt to format when no linting results are found',
            async () =>
            {
                const formatResults = createFormatter(4);
                const files = getFiles();
        ...
        it
        (
            'should emit an error if an invalid formatter is passed',
            async () =>
            {
                const files = getFiles();
                const lintStream =
        ...
        it
        (
            'should emit an error if a linted file has no ESLint instance',
            async () =>
            {
        ...
        it
        (
            'should emit an error if the linted files have different ESLint instances',
            async () =>
            {
...
(
    ...
    () =>
    {
        ...
        it
        (
            'should format individual ESLint results',
            async () =>
            {
                const formatResult = createFormatter(1);
                const files = getFiles();
        ...
        it
        (
            'should memoize formatters per ESLint instance',
            async () =>
            {
                const createTestFile =
                eslintInstance =>
