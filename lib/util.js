...
(options = { }) =>
{
    ...
    options;
    const typeofQuiet = typeof quiet;
    if (typeofQuiet !== 'boolean' && typeofQuiet !== 'function' && typeofQuiet !== 'undefined')
        throw Error('Option quiet must be a boolean or a function');
    const typeofWarnIgnored = typeof warnIgnored;
    if (typeofWarnIgnored !== 'boolean' && typeofWarnIgnored !== 'undefined')
        throw Error('Option warnIgnored must be a boolean');
